...

            {
                showProfile && (
                    ...
                    <div className={isDark ? "dark" : "''"}>
                        ...
                        >
                            <div className='absolute w-64 bg-white dark:bg-gray-800 shadow-xl  -top-4 dark:shadow-gray-900 -right-10 rounded-lg py-4'>
                                <div className=''>
                                ...
                                <div>
                                    <div className='px-6 py-3 cursor-pointer hover:bg-purple-50'>
                                        <div className='flex gap-5 items-center'>
                                            ...
                                            <div className='text-gray-600 dark:text-gray-300 flex-1 text-sm space-y-1'>
                                                <button onClick={logout} className='text-base font-medium'>Sign Out</button>
                                            </div>
                                        </div>
                                    </div>
                                    <hr className='dark:opacity-10' />
