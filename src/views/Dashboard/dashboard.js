                        ...
                        <div className="flex flex-wrap items-center text-sm justify-between">
                          <div className="flex items-center ">
                            ...
                            <div className="relative w-8 h-8 mr-3 rounded-full">
                              <img className="object-cover w-full h-full rounded-full" src={each.gender === "male" ? male : female} alt="" loading="lazy" />
  ...
  return (
    ...
    <>
      <div className="container mx-auto pb-16">
        ...
        {/* CTA */}
        <NavLink className="flex items-center justify-between p-4  text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" to="https://github.com/AyodejiSheen/RequestAppFront">
          <div className="flex items-center">
